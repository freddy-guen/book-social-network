...
/**
 * Opérations sur les livres (ajout, emprunt, archivage, etc)
 */
...
export class BookService extends BaseService {
  ...
  /**
   * Ajouter la couverture d'un livre.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
  ...
  /**
   * Mettre à jour le statut partageable d'un livre.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
  ...
  /**
   * Récupérer tous les livres rendus par l'utilisateur connecté.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
  ...
  /**
   * Lister tous les livres disponibles pour l'utilisateur connecté.
   *
   *
   *
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
